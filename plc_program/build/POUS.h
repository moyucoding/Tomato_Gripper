...
typedef struct {
  ...
  __DECLARE_VAR(SINT,SPEED)
  __DECLARE_VAR(STRING,TARGET)
...
typedef struct {
  ...
  __DECLARE_VAR(LINT,COUNTER)
  __DECLARE_VAR(LINT,ONE)
  __DECLARE_VAR(SINT,SPEED)
  __DECLARE_VAR(STRING,TARGET1)
  __DECLARE_VAR(STRING,TARGET2)
  R_TRIG R_TRIG0;
  MOVEARM FUNCTIONBLOCK1;
  MOVEARM FUNCTIONBLOCK0;
  R_TRIG R_TRIG1;
  __DECLARE_VAR(BOOL,OR8_OUT)
  __DECLARE_VAR(BOOL,ADD11_ENO)
  __DECLARE_VAR(LINT,ADD11_OUT)
